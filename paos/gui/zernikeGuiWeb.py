...
from PySimpleGUIWeb import RELIEF_SUNKEN
from PySimpleGUIWeb import Submit
from PySimpleGUIWeb import Text, Button, Column, Frame
from PySimpleGUIWeb import Window, WINDOW_CLOSED
from PySimpleGUIWeb import popup
...
class ZernikeGUI(SimpleGUI):
    ...
    def make_window(self):
        ...
        layout = [
            ...
            [Column(layout=list(itertools.chain(
                ...
                scrollable=True, vertical_scroll_only=True, key='zernike')],
            [Text('', size=(10, 2))],
            itertools.chain([
    ...
    def __call__(self):
        ...
        while True:
            ...
            if event == "-EXIT ZERNIKES-" or event == WINDOW_CLOSED:
                self.close_window()
                break
