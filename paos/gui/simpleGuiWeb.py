...
from PySimpleGUIWeb import Text, Column, InputText, Frame, ProgressBar
from PySimpleGUIWeb import Window
from PySimpleGUIWeb import popup_quick_message
...
class SimpleGUI:
    ...
    def collapse_frame(title, layout, key):
        ...
        """
        return Frame(title=title, layout=layout, key=key)
    ...
    def collapse_column(layout, key):
        ...
        """
        return Column(layout=layout, key=key)
    ...
    def reset_progress_bar(progress_bar):
        """
        Given a simulated progress bar element, it resets it
    ...
    def update_progress_bar(progress_bar):
        """
        Given a simulated progress bar element, it updates it
        ...
        """
        progress_bar.update('█' * int(progress_bar.metadata))
        return progress_bar
